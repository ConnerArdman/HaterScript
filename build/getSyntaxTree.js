export default function getSyntaxTree(declareFunction, declareObjectKey, declareVar, decrement, endFunction, endIfBlock, endWhileLoop, increment, invokeFunction, ifCheck, log, whileLoop) {
  return {
